...
namespace BigBrother.UILayer
{
    ...
    sealed partial class App : MvvmAppBase
    {
        ...
        {
            NavigationService.Navigate("PhoneCallList", null);
        }
        ...
        protected override void OnInitialize(IActivatedEventArgs args)
        {
            ...
            _container.RegisterType<IPhoneCallRepository, PhoneCallRepository>(new ContainerControlledLifetimeManager());

            // Register web service proxies
            _container.RegisterType<IPhoneCallServiceProxy, PhoneCallServiceProxy>(new ContainerControlledLifetimeManager());
            ...
            {
                var viewModelTypeName = string.Format(CultureInfo.InvariantCulture, "BigBrother.UILogic.ViewModels.{0}ViewModel, BigBrother.UILogic, Version=1.0.0.0, Culture=neutral", viewType.Name);
        ...
        protected override void OnRegisterKnownTypesForSerialization()
        {
            ...
            SessionStateService.RegisterKnownType(typeof(PhoneCall));
        }
    }
}
